<div class="sidebar">
    ...
    <ul class="nav-list"> 
        ...
        @if (auth()->user()->role === 'resepsionis')
            <li>
                <a href="/reservasi" class="a {{ ($title === "Reservasi | Hotel.LuuL") ? 'open1' : '' }}">
                    <i class='bx bx-hotel {{ ($title === "Reservasi | Hotel.LuuL") ? 'open1' : '' }}'></i>
                    <span class="links_name {{ ($title === "Reservasi | Hotel.LuuL") ? 'open1' : '' }}">Reservasi</span>
                </a>
                <span class="tooltip {{ ($title === "Reservasi | Hotel.LuuL") ? 'open1' : '' }}">Reservasi</span>
            </li>
        @endif
        <li class="profile">
