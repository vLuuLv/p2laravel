...
@section('content')
          ...
          <div class="content-header">
            <div class="container-fluid">
              <div class="row pb-1 mb-1">
                <div class="col-sm-6">
                  <h2 class="title-mobile mt-4"><b>Fasilitas Hotel</b></h2>
                </div>
                        ...
                        <table class="table table-bordered yajra-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/images/fasilitas-hotel/{{ $data->name_img }}" target="_blank">preview image</a></td>
                                    <td>
                                        <button class="btn btn-sm btn-success mx-1" data-toggle="modal" data-target="#editFasilitasHotel{{ $data->id }}" style="float:left;"><i class="fas fa-edit"></i></button>
                                        ...
                                        <form action="/fasilitas-hotel/{{ $data->id }}" method="post" style="float:left;" class="mx-1">
                                            @method('delete')
                                            @csrf
    ...
    {{-- modal tambah --}}
    <div class="modal fade" id="tambahFasilitasHotel" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="tambahFasilitasHotelLabel" aria-hidden="true" >
        <form class="mt-1" action="/fasilitas-hotel" method="post" enctype="multipart/form-data">
            <div class="modal-dialog">
            <div class="modal-content" style="background-color: #f5f5f5;border-radius:10px;">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahFasilitasHotelLabel">Tambah Fasilitas Hotel</h5>
    ...
    {{-- modal edit --}}
    @foreach($fasilitas as $data)
    <div class="modal " id="editFasilitasHotel{{ $data->id }}" data-backdrop="static" tabindex="-1" aria-labelledby="editFasilitasHotel{{ $data->id }}Label" aria-hidden="true" >
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: #f5f5f5;border-radius:10px;">
                <div class="modal-header">
                    <h5 class="modal-title" id="editFasilitasHotel{{ $data->id }}Label">Edit Fasilitas Hotel</h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="/fasilitas-hotel/{{ $data->id }}" method="post" enctype="multipart/form-data">
                    <div class="modal-body" style="background-color: #e4e9f7">
                        @csrf
                        @method('put')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Keterangan :</label>
                            <input required  value="{{ $data->keterangan }}" type="text" class="form-control" name="keterangan" id="keterangan">
                        </div>
                        <div class="mb-3">
    ...
    $(function () {
        var table = $('.yajra-datatable').DataTable({
          dom: 'l<"toolbar">frtip',
            ...
            $("div.toolbar")
                .html('<a type="button" class="create p-2 px-3 mb-2 btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#tambahFasilitasHotel"><i class="bi bi-plus-lg text-light"></i><span class="text-light">Tambah</span></a>');           
            },  
      });
